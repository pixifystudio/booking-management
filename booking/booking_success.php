                    ...
                    <div class="form-wrap">
                      <div>
                        ...
                        <form id="login_form" method="POST">
                          <div class="title-main align-left">
                            Terimakasih <?php echo $nama ?>
                            Selanjutnya yang harus kamu lakukan
                            1. Cek email kamu untuk detail pemesanan
                            2. Melakukan pembayaran DP sebesar Rp20.000 melalui rekening BRI 409101008799535 a.n Dicky Pramana Sukm
                            3. Kirim bukti pembayaran melalui no WhatsApp: 08517121209
                            Sampai berjumpa di Self Studio :)
                          </div>
