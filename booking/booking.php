                                ...
                                <div class="form-group">
                                  ...
                                  <select class="form-select" id="waktu" name="txtWaktu" aria-label="Default select example" autocomplete="off" required>
                                    ...
                                    if ($txtTanggal != '') {
                                      ...
                                      } else  if ($nama_hari == 'Sunday' ) {
                                        $mySql  = "SELECT * from jadwal j where j.status ='1' and j.availability ='0'  and j.jam >='22:00' and j.jam <='22:00' and j.jam not in (select jam from booking where tanggal = '$txtTanggal') order by j.jam asc;";
                                      }  else {
                                        if ($nama_hari == 'Friday') {
