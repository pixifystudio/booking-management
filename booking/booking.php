                                  ...
                                  <select class="form-select" id="waktu" name="txtWaktu" aria-label="Default select example" autocomplete="off" required>
                                    ...
                                    if ($txtTanggal != '') {
                                      ...
                                      if ($nama_hari == 'Sunday' || $nama_hari == 'Saturday') {
                                        ...
                                        if ($nama_hari == 'Friday' ) {
                                          $mySql  = "SELECT * from jadwal j where j.status ='1' and j.availability ='0'  and j.jam >='13:00' and j.jam <'19:00' and j.jam not in ('17:20','17:40','18:00','18:20','18:40') and j.jam not in (select jam from booking where tanggal = '$txtTanggal') order by j.jam asc;";
                                        }
                                        else {
