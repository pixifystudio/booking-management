	...
	<div id="wrapper" style="max-width: 600px; margin: auto auto; padding: 20px;">
		...
		<div id="content" style="font-size: 16px; padding: 25px; background-color: #fff;
			...
			<h1 style="font-size: 22px;">
				<center> <img src="https://i.imghippo.com/files/QemjM1713056172.png" style="width: 40%;" alt="logo" />
				</center>
				<center>
			...
			<p class="stylefont">Terimakasih, kamu sudah melakukan Booking di jam <b>{TIME}</b> pada <b>{HARI}</b>, <b>{DATE}</b></p>
