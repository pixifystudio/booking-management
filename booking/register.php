...
<head>
  ...
  <title>Education - Register </title><!-- Styles--><!-- Put the 3rd/plugins css here-->
        ...
        <div class="page-wrap">
          <div class="hidden-md-up">
            <div class="logo logo-header">
              <a href="index.html">
                <img src="./assets/images/education-logo.svg" alt="logo">
              </a>
            </div>
          </div>
                  ...
                  <div class="col-md-5">
                    <div class="hidden-sm-down">
                      <div class="greeting">
                        ...
                        <div class="logo">
                          <img src="./assets/images/education-logo.svg" alt="logo" />
                          <p class="use-text-subtitle2">Education</p>
                        </div>
                        <h4 class="use-text-title2">Nice to meet you :)</h4>
                        <h5 class="use-text-subtitle2">Just register to join with us</h5>
                      </div>
                    </div>
                  </div>
                  <div class="col-md-7">
                      ...
                      <div>
                        <div class="head">
                          <div class="title-main align-left">
                            <h4 class="secondary"><span>Register</span></h4>
                            <p class="desc use-text-subtitle2"></p>
                          </div><a class="btn btn-flat waves-effect button-link" href="login.html">
                        ...
                        <form id="register_form" method="POST">
                          ...
                          <div class="btn-area mt-5">
                            ...
                            <button class="flex btn secondary btn-large waves-effect" type="submit">Continue</button>
                          </div>
                        </form>
                      </div>
                    </div>
