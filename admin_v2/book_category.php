    ...
    <div class="content-header row">
      <div class="content-header-left col-md-9 col-12 mb-2">
        <div class="row breadcrumbs-top">
          <div class="col-12">
            <h2 class="content-header-title float-start mb-0">Book Category</h2>
            <div class="breadcrumb-wrapper">
              <ol class="breadcrumb">
                <li class="breadcrumb-item active"><a>Master Data</a>
                </li>
                <li class="breadcrumb-item active"><a>Book Category</a>
                </li>
              </ol>
            </div>
          </div>
          ...
          <div class="card">
            <div class="card-header border-bottom">
              ...
              <div class="content-header-right text-md-end col-md-8 col-12 d-md-block d-none">
                <form role="form" action="?page=Book-Category-Add" method="POST" name="form1" target="_self" id="form1">
                  <div class="row">
                    ...
                    <div class="col-md-4 col-12 ps-25">
                      <div class="mb-1">
                        <button type="submit" class="btn btn-danger w-100" name=""><i data-feather='plus'></i> Add Book Category</button>
                      </div>
                    </div>
                  </div>
                </form>
