...
$mySql   = "SELECT vd.*, df.document_file_name FROM view_document vd JOIN document_files df ON vd.document_id = df.document_id where vd.document_id='$getID' and vd.document_version='$getVersion'";
...
$documentFile = $myData['document_file_name'];
      ...
      <div class="content-header row">
        <div class="content-header-left col-md-9 col-12 mb-2">
          <div class="row breadcrumbs-top">
            <div class="col-12">
              <h2 class="content-header-title float-start mb-0">Digital Content Management</h2>
        ...
        <div class="content-header-right text-md-end col-md-3 col-12 d-md-block d-none">
          <div class="mb-1 breadcrumb-right">
            <a class="btn-icon btn btn-primary btn-round btn-sm dropdown-toggle" href="?page=Content-Management-Digital" aria-haspopup="true" aria-expanded="false"><i data-feather="arrow-left"></i></a>
          </div>
        </div>
      </div>
              ...
              <div class="row my-2 align-items-center justify-content-center">
                <div class="col-12 col-md-4 d-flex align-items-center justify-content-center mb-2 mb-md-0">
                  ...
                  <div class="col-12 col-md-12">
                    ...
                    <br>
                    <?php
                    $ext = pathinfo($documentFile, PATHINFO_EXTENSION);
                    if ($ext == 'pdf' || in_array($ext, ['mp4', 'webm', 'mkv', 'avi', '3gp', 'mov', 'flv'])) {
                      // Jika PDF atau media video, tampilkan tombol "Open Content"
                      echo "<a href='?page=Document-Detail-PDF&id={$myData['document_id']}&v={$myData['document_version']}' target='_new' class='btn btn-outline-secondary' style='width:100%'><b>Open Content</b></a>";
                    } else {
                      // Jika bukan PDF atau media video, tampilkan tombol "Download"
                      echo "<a href='{$documentFile}' class='btn btn-outline-secondary' download style='width:100%'><b>Download</b></a>";
                    }
                    ?>
                  </div>
                </div>
