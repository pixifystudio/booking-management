        ...
        <div class="row breadcrumbs-top">
          <div class="col-12">
            ...
            <div class="breadcrumb-wrapper">
              <ol class="breadcrumb">
                <!-- <li class="breadcrumb-item active"><a>List Book Digital</a> -->
                </li>
              </ol>
            </div>
          </div>
          ...
          <div class="card">
            <div class="card-header border-bottom">
              ...
              <div class="content-header-rigth col-md-1">
                <a href='?page=Content-Management-Digital-Add' type="submit" class="btn btn-secondary" name=""><i data-feather='plus'></i> Add</a>
              </div>
                ...
                <tbody>
                  ...
                  ?>
                    ...
                    <tr>
                      ...
                      <td><a href="?page=Content-Management-Digital-Status&id=<?php echo $Code;  ?>" alt="View Data"><u><?php echo $myData['document_status']; ?></u></a></td>
                      ...
                      <td>
                        <?php if ($myData['document_status'] != 'Reviewed' && $myData['document_status'] != 'Request Delete') { ?>
                          <a href="?page=Content-Management-Digital-Edit&id=<?php echo $Code; ?>&v=<?php echo $Version; ?>" target="_self" alt="Edit Data"><i class="fa fa-edit fa-fw"></i> Edit</a>
                        <?php } ?>
                      </td>
                      <td>
                        <?php if ($myData['document_status'] != 'Reviewed' && $myData['document_status'] != 'Request Delete') { ?>
                          <a href="?page=Content-Management-Digital-Delete&id=<?php echo $Code; ?>&v=<?php echo $Version; ?>" target="_self" alt="Delete Data" onclick="return confirm('ARE YOU SURE TO DELETE THIS DATA?')"><i class="fa fa-trash-o fa-fw"></i> Delete</a>
                        <?php } ?>
                      </td>
                    </tr>
                  <?php } ?>
