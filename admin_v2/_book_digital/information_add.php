  ...
  if (isset($_POST['btnSubmit'])) {
    ...
    if (count($pesanError) >= 1) {
      ...
      try {
        ...
        commit();
        echo "<meta http-equiv='refresh' content='0; url=?page=Book-Management-Digital&msg=add'>";
        exit;
      } catch (Exception $e) {
        rollback();
        // echo "<meta http-equiv='refresh' content='0; url=?page=Book-Management-Digital-Add-Add&id=$Code&info=" . $e->getMessage() . "'>";
        // echo $e->getMessage();
      }
    }
  }
                    ...
                    <form action="<?php $_SERVER['PHP_SELF']; ?>" method="post" name="form1" target="_self" enctype="multipart/form-data">
                      <div class="row">
                        ...
                        <div class="col-md-2 col-12">
                          ...
                          <div class="mb-1">
                            <label class="form-label" for="status">Book File</label>
                            <input type="file" id="status" class="form-control" required name="txtFileBook" placeholder="Book File" />
                          </div>
                        </div>
