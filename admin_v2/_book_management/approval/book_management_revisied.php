        ...
        <div class="row breadcrumbs-top">
          <div class="col-12">
            ...
            <div class="breadcrumb-wrapper">
              <ol class="breadcrumb">
                <li class="breadcrumb-item active"><a>Book Revisied</a>
                </li>
                <li class="breadcrumb-item active"><a> Book List</a>
                </li>
              </ol>
            </div>
          </div>
            ...
            <div class="card-datatable">
              <table id="datatable-responsive" class="table datatables-basic table-striped" width="100%">
                ...
                <tbody>
                  ...
                  $mySql   = "SELECT v.* FROM view_document v where category_level_1='PHYSICAL'";
