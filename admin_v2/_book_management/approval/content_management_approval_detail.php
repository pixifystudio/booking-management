  ...
  <div class="app-content content ecommerce-application">
    ...
    if (isset($_POST['btnReject'])) {
      ...
      if ($myQry) {
        echo "<meta http-equiv='refresh' content='0; url=?page=Content-Management-Approval&code=$code'>";
      }
      exit;
    }
        ...
        <div class="content-header row">
            ...
            <div class="row breadcrumbs-top">
              <div class="col-12">
                ...
                <div class="breadcrumb-wrapper">
                  <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="?page=Content-Management-Approval&code=<?= $code; ?>">Detail Approval</a>
                    </li>
          ...
          <div class="content-header-right text-md-end col-md-3 col-12 d-md-block d-none">
            <div class="mb-1 breadcrumb-right">
              <a class="btn-icon btn btn-primary btn-round btn-sm dropdown-toggle" href="?page=Content-Management-Approval&code=<?= $code ?>" aria-haspopup="true" aria-expanded="false"><i data-feather="arrow-left"></i></a>
            </div>
          </div>
        </div>
              ...
              <div class="card">
                <div class="row my-2 align-items-center justify-content-center">
                  <div class="col-12 col-md-4 d-flex align-items-center justify-content-center mb-2 mb-md-0">
                    ...
                    <div class="col-12 col-md-12">
                      ...
                      <ul class="list-unstyled m-lg-75">
                        ...
                        <div class="row mt-75">
                          <div class='col-6'>
                            <span class="fw-bolder">Merk:</span>
                          </div>
                          <div class='col-6'>
                      ...
                      <br>
                      <a href="?page=Document-Detail-PDF&id=<?php echo $myData['document_id']; ?>&v=<?php echo $myData['document_version']; ?>" class="btn btn-outline-primary" style='width:100%'><b>Open Content</b> </a>
                  ...
                  <div class="col-12 col-md-7">
                    ...
                    <p class="card-text">
                      <?php echo $myData['document_description_en'] ?>
                    </p>
                    <hr />
                    ...
                    $mySql1 = "SELECT  * FROM document_review where document_id = '$getID' limit $halaman_awal, $batas";
                    $myQry1 = mysqli_query($koneksidb, $mySql1) or die("RENTAS ERP ERROR : " . mysqli_error($koneksidb));
                    $nomor = $halaman_awal + 1;

                    $mySql = "SELECT  * FROM document_review where document_id = '$getID' limit 100";
