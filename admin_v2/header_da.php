...
<head>
    ...
    <link rel="apple-touch-icon" href="../app-assets/images/logo/logoSTIN.png">
    <link rel="shortcut icon" type="image/x-icon" href="../app-assets/images/logo/logoSTIN.png">
