          ...
          <div class="card">
            <div class="card-header border-bottom">
              ...
              <div class="content-header-right text-md-end col-md-8 col-12 d-md-block d-none">
                <form role="form" action="?page=Management-User-Add" method="POST" name="form1" target="_self" id="form1">
                  <div class="row">
                    ...
                    <div class="col-md-4 col-12 ps-25">
                      <div class="mb-1">
                        <a href='?page=Management-User-Add' type="submit" class="btn btn-secondary w-100" name=""><i data-feather='plus'></i> Add User</a>
                      </div>
                    </div>
                  </div>
                </form>
                ...
                <tbody>
                  ...
                  ?>
                    ...
                    <tr>
                      ...
                      <td><?php echo $myData['activation_date']; ?></td>

                      <?php if ($myData['position'] == 'Member' && $position == 'Pustakawan') { ?>

                        <td><a href="?page=Management-User-Edit&id=<?php echo $Code; ?>" target="_self" alt="Edit Data"><i class="fa fa-edit fa-fw"></i> Edit</a></td>
                        <td><a href="?page=Management-User-Delete&id=<?php echo $Code; ?>" target="_self" alt="Delete Data" onclick="return confirm('ARE YOU SURE TO DELETE THIS DATA?')"><i class="fa fa-trash-o fa-fw"></i> Delete</a></td>
