...
<div class="app-content content ">
  ...
  if (isset($_POST['btnSubmit'])) {
    ...
    if ($_FILES['txtPhoto']['name'] != "") {
      ...
      $file_tmp2   = $_FILES['txtPhoto']['tmp_name'];
    ...
    ; # SIMPAN DATA KE DATABASE. 
      ...
      $mySql    = "UPDATE master_user set user_id = '$dataCode' , username='$txtUsername', user_fullname='$txtFullname',
       user_group = '$txtUsergroup', user_email='$txtEmail', user_photo='$file_photo', user_status = '$txtStatus'
       , company_id = 'CO-0000001',branch = '$txtBranch', division ='$txtDivision', department = '$txtDepartment'
       , unit= '$txtUnit', position='$txtPosition',updated_by = '$ses_nama',updated_date = now(), user_phone = '$txtPhone' $setpassword where user_id='$dataCode'";
      $myQry = mysqli_query($koneksidb, $mySql) or die("Error query " . mysqli_error($koneksidb));
      if ($myQry) {
        echo "<meta http-equiv='refresh' content='0; url=?page=Management-Admin'>";
      }
      exit;
    }
