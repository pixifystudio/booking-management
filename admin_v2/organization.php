    ...
    <div class="content-header row">
      <div class="content-header-left col-md-9 col-12 mb-2">
        <div class="row breadcrumbs-top">
          <div class="col-12">
            <h2 class="content-header-title float-start mb-0">Organization</h2>
            <div class="breadcrumb-wrapper">
              <ol class="breadcrumb">
                <li class="breadcrumb-item active"><a>Master Data</a>
                </li>
                <li class="breadcrumb-item active"><a>Organization</a>
                </li>
              </ol>
            </div>
          </div>
                ...
                <form role="form" action="?page=Report-Validasi" method="POST" name="form1" target="_self" id="form1">
                  <div class="row">
                    ...
                    <div class="col-md-4 col-12 ps-25">
                      <div class="mb-1">
                        <a href='?page=Organization-Add' type="submit" class="btn btn-danger w-100" name=""><i data-feather='plus'></i> Add Organization</a>
                      </div>
                    </div>
                  </div>
                </form>
