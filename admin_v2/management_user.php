<?php
$_SESSION['SES_TITLE'] = "Management User";
          ...
          <div class="col-12">
            ...
            <div class="breadcrumb-wrapper">
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active"><a >Management User</a>
                </li>
              </ol>
            </div>
          </div>
                ...
                <form role="form" action="?page=Management-User-Add" method="POST" name="form1" target="_self" id="form1">
                  <div class="row">
                    ...
                    <div class="col-md-4 col-12 ps-25">
                      <div class="mb-1">
                        <a href='?page=Management-User-Add' type="submit" class="btn btn-danger w-100" name=""><i data-feather='plus'></i> Add User</a>
                      </div>
                    </div>
                  </div>
                </form>
