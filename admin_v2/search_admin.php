...
<div class="right_col" role="main">
	...
	if (isset($_POST['btnSubmit'])) {
		...
		if (count($pesanError) >= 1) {
			...
			if ($myQry) {
				echo "<meta http-equiv='refresh' content='0; url=?page=Search-Admin&id=" . $txtSearch . "'>";
			}
			exit;
		}
	} // Penutup Tombol Submit
	$txtSearch = isset($txtSearch) ? $txtSearch : '';
	$_SESSION['SES_PAGE'] = "?page=Search-Admin&id=$txtSearch";
	$_SESSION['SES_PAGE'] = "?page=Search-Admin&id=$txtSearch";
						...
						<div class="col-md-12 col-sm-12 col-xs-12">
												...
												?>
													...
													<tr>
														<td>
															...
															<h2><b><a href="?page=Content-Management-Digital-View&id=<?php echo $Kode; ?>&v=<?php echo $Version; ?>"><?php echo $Title; ?></a></b></h2>
							...
							and v.document_version=f.document_version and v.document_content like '%$idquery%' and v.document_id='$Kode'
											group by v.document_id, v.document_version,v.document_file_title order by f.document_order";
																	$myQry2 	= mysqli_query($koneksidb, $mySql2)  or die("Query  salah : " . mysqli_error($koneksidb));
