    ...
    <div class="content-header row">
      <div class="content-header-left col-md-9 col-12 mb-2">
        <div class="row breadcrumbs-top">
          <div class="col-12">
            <h3 class="content-header-title float-start mb-0">Dashboard</h3>
            <div class="breadcrumb-wrapper">
              <ol class="breadcrumb">
                <li class="breadcrumb-item">Libra</li>
              </ol>
            </div>
          </div>
        </div>
      ...
      <div class="row">
          ...
          <div class="card card-browser-states">
            <div class="card-header">
              <div>
                ...
                ?>
                <h4 class="card-title">Top 5 Visitor</h4>
              </div>
        ...
        <div class="col-lg-6 col-md-6 col-12">
          <div class="card card-browser-states" style="height:93% ;">
            <div class="card-header">
              <div>
                <h4 class="card-title">Top 5 Asset Borrower</h4>
              </div>
              <div class="dropdown chart-dropdown">
                <!-- <i data-feather='calendar'></i> 2022-01-01 to 2022-12-30 -->
              </div>
        ...
        <div class="col-lg-6 col-md-6 col-12">
          <div class="card card-browser-states" style="height:93% ;">
            <div class=" card-header">
              <div>
                <h4 class="card-title">Top 10 Asset </h4>
              </div>
              <div class="dropdown chart-dropdown">
                <!-- <i data-feather='calendar'></i> 2022-01-01 to 2022-12-30 -->
              </div>
            ...
            <div class="card-body">
              <?php
              $mySql     = "SELECT *,sum(total) as sum_total FROM view_log_document_top10  where category_level_1 =  'PHYSICAL'  group by document_title_id  order by sum_total desc limit 10";
              $myQry     = mysqli_query($koneksidb, $mySql)  or die("BIBLIOTECA ERROR  :  " . mysqli_error($koneksidb));
        ...
        <div class="col-lg-6 col-md-6 col-12">
          ...
          ">
              <h4 class="card-title">Total Borrowed Asset</h4>
...
<script>
  ...
  $databulan2 = array();
  $datatotal2 = array();
  $mySql2   = "select log_date, sum(total) as total from view_log_document_read where category_level_1 ='PHYSICAL'  group by log_date order by log_date asc limit 10";
