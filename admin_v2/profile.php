...
if (isset($_POST['btnSubmit'])) {
  ...
  if (count($pesanError) >= 1) {
    ...
    $mySql    = "UPDATE master_user SET user_photo='$file_photo', updated_by='$ses_nama' $sqlPasword, updated_date=now()
						    WHERE user_id = '$user_id'";
    $myQry = mysqli_query($koneksidb, $mySql) or die("Error query " . mysqli_error($koneksidb));
    if ($myQry) {
      echo "<meta http-equiv='refresh' content='0; url=?page=Profile&msg=add'>";
    }
    exit;
  }
        ...
        <div class="col-12 col-sm-12 mb-1">
          ...
          <center>
            <div class="col-6">
              ...
              <a href="?page=Main" type="reset" class="btn btn-outline-secondary mt-1">Batalkan </a>
            </div>
          </center>
          </form>
