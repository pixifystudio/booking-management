...
$_SESSION['SES_PAGE'] = "?page=Buku-Digital";
...
<div class="app-content content ">
  ...
  <div class="content-wrapper ">
    <div class="content-header row">
      <div class="content-header-left col-md-9 col-12 mb-2">
        <div class="row breadcrumbs-top">
          <!-- <div class="col-12">
            <h3 class="content-header-title float-start mb-0">Kategori Buku Digital</h3>
          </div> -->
        </div>
      </div>
    </div>
    ...
    <div class='row'>
      <div class='col-11'>
        <h2 class="mt-3 mb-2"><?php echo _NEWBOOK ?><small style="color:brown"> <?php echo _DIGITAL ?></small></h2>
      </div>
      <div class='col-1'>
        <a href="?page=Buku-Digital-Detail" type="reset" class="mt-3"><?php echo _MORE ?> </a>
      </div>
    </div>
    ...
    <div class="row">
      <div class="card-body">
        <div class="swiper-multiple swiper-container ml-10">
          <div class="swiper-wrapper swiper-slide m-lg-0">
            <?php
            $mySql = "SELECT  * FROM view_document where category_level_1 = 'DIGITAL' group by document_id order by document_id asc limit 5";
            $myQry = mysqli_query($koneksidb, $mySql) or die("BIBLIOTECA ERROR  : " . mysqli_error($koneksidb));
            while ($myData = mysqli_fetch_array($myQry)) {
              ...
              $num_char = 10;
              $text = $myData['category_level_3'];
              $text = substr($text, 0, $num_char) . '...';

              $num_char = 10;
              $textp = $myData['document_publisher'];
              $textp = substr($textp, 0, $num_char) . '...';


              $num_char = 26;
              $textj = $myData['document_title_' . $lang];
              $textj = substr($textj, 0, $num_char) . '...';


            ?>
              <div class="swiper-slide">
                <a href="?page=Buku-Digital-Detail-View&id=<?php echo $id ?>">
                  <div class="col-md-12">
                    <div class="card" style=' width: 70%'>
                      <img class="card-img-top" src="../uploads/cover/<?php echo $cover ?>" style='height:400px' alt="Card image cap" />
                      <div class="card-body">
                        <h4 class=""><a href="?page=Buku-Digital-Detail-View&id=<?php echo $id ?>"><?php echo $textj ?></a></h4>
                        <h5 style='color:brown' class=""></h5>
                        <p class="card-text">
                          <?php echo $text ?> | <?php echo _BY ?> <?php echo $textp ?>
                        </p>
                        <p class="card-text">
      ...
      <div class='row'>
        <div class='col-11'>
          <h2 class="mt-3 mb-2"><?php echo _POPULARBOOK ?><small style="color:brown"> <?php echo _DIGITAL ?></small></h2>
        </div>
        <div class='col-1'>
          <a href="?page=Buku-Digital-Detail" type="reset" class="mt-3"><?php echo _MORE ?></a>
        </div>
