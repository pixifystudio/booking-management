...
$_SESSION['SES_PAGE']="?page=Document-Favourite";
$_SESSION['SES_BACK']="?page=Document-Favourite";
          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3><?php echo _FAVOURITE; ?></h3>
              </div>
              <div class="title_right">
              	<div class="form-group pull-right">
                	<h6><a href="?page=Main" ><i class="fa fa-home"></i> <?php echo _HOME ?></i></a></a> / <?php echo _FAVOURITE; ?></h6>
                </div>
              </div>
            </div>
                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <ul role="menu" class="dropdown-menu">
                      <li><a href="?page=Document-Favourite"><?php echo _ALL.' '._CATEGORY ?></a></li>
                      <?php
...
FROM view_document_favourite WHERE user_id='".$_SESSION['SES_USERID']."'  
...
order by id";
					...
					while ($myData = mysqli_fetch_array($myQry)) {
						...
						echo "<li><a href='?page=Document-Favourite&ca=$dataCategoryID'>$Category</a></li>";
					}
					?>
                  ...
                  <div class="x_content table-responsive"> 
                    ...
                    <table id="datatable-responsive-<?php echo $lang ?>" class="table table-striped  table-hover hana_table dt-responsive" cellspacing="0" width="100%">
                                    <thead>
                                        <tr>
                                            <th>No</th>
                                            <th></th>
									...
									$mySql 	= "SELECT * FROM view_document_favourite where user_id='".$_SESSION['SES_USERID']."' and category_id like '%$Categoryid%' order by document_date desc";
									$myQry 	= mysqli_query($koneksidb,$mySql)  or die ("Error query ".mysqli_error());
									$nomor  = 0; 
									while ($myData = mysqli_fetch_array($myQry)) {
										$nomor++;
