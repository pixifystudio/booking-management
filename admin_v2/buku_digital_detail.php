...
$_SESSION['SES_PAGE'] = "?page=Buku-Digital-Detail";
...
$mySql = "SELECT  * FROM view_document where category_level_1 = 'DIGITAL' and document_description_en != '' $kategori1 $rating1 group by document_id order by document_id asc";
                      ...
                      <ul class="list-unstyled price-range" id="price-range">
                        ...
                        <li>
                          <div class="form-check">
                            ...
                            <input type="radio" id="priceRange2" name="price-range" href='' class="form-check-input" />
                        ...
                        <li>
                          <div class="form-check">
                            <input type="radio" id="priceARange3" name="price-range" class="form-check-input" checked />
                      ...
                      <ul class="list-unstyled categories-list">
                        <li>
                          <div class="form-check">
                            ...
                            <label class="form-check-label" for="category1"><a href="?page=Buku-Digital-Detail&order=<?php echo $setorder ?>&halaman= <?php echo $halaman ?>&kategori="><?php echo _ALL . ' ' . _CATEGORY ?></a></label>
                          </div>
                        </li>
                        <?php
                        $mySql2 = "SELECT * FROM master_category where category_level_1 = 'DIGITAL' group by category_level_1, category_level_2 order by category_level_2";
                        ...
                        ?>
                          <li>
                            <div class="form-check">
                              ...
                              <label class="form-check-label" for="category2"><a href="?page=Buku-Digital-Detail&order=<?php echo $setorder ?>&halaman= <?php echo $halaman ?>&kategori=<?php echo $myData2['category_level_2'] ?>"><?php echo $myData2['category_level_2'] ?></a></label>
                            </div>
                          </li>
                        <?php } ?>
                      </ul>
                        ...
                        ?>
                          <li>
                            <div class="form-check">
                              ...
                              <label class="form-check-label" for="category3"><a href="?page=Buku-Digital-Detail&order=<?php echo $setorder ?>&halaman= <?php echo $halaman ?>&kategori=<?php echo $kategori ?>&rating= <?php echo $document_value ?>">
          ...
          <div class="content-detached content-right">
            <div class="content-body">
              ...
              <section id="ecommerce-products" class="grid-view">
                ...
                $mySql = "SELECT  * FROM view_document where category_level_1 = 'DIGITAL' $kategori1 $rating1  group by document_id order by document_id asc limit $halaman_awal, $batas";
                $myQry = mysqli_query($koneksidb, $mySql) or die("BIBLIOTECA ERROR  : " . mysqli_error($koneksidb));
                $nomor = $halaman_awal + 1;

                $mySql2 = "SELECT  * FROM view_document where category_level_1 = 'DIGITAL' $kategori1 $rating1  group by document_id order by document_id asc limit 100";
                $myQry2 = mysqli_query($koneksidb, $mySql2) or die("BIBLIOTECA ERROR  : " . mysqli_error($koneksidb));
                ...
                ?>
                  <div class="card ecommerce-card">
                    ...
                    <div class="card-body">
                      ...
                      <h5 class="item-name">
                        ...
                        <p class="card-text item-description">
                          <i class="mr-5" data-feather="star"></i>
                        </p>
                        <p class="card-text item-description">
                    ...
                    <div class="item-options text-center">
                      ...
                      <a href="?page=Buku-Digital-Detail-View&id=<?php echo $document_id ?>" class="btn btn-primary" style="width:100%">
                      ...
                      <ul class="pagination justify-content-center mt-2">
                        ...
                        <li class="page-item">
                          <a class="page-link" <?php if ($halaman > 1) {
                                                  ...
                                                  echo "href='?page=Buku-Digital-Detail&order=$setorder&halaman=$previous $kategori $rating'";
                                                } ?>>
                            < </a>
                        </li>
                        <?php
                        for ($x = 1; $x <= $total_halaman; $x++) {
                          if ($halaman == $x) { ?>
                            <li class="page-item active"><a class="page-link" href="?page=Buku-Digital-Detail&order=<?php echo $setorder ?>&halaman=<?php echo $x ?> <?php echo $kategori ?> <?php echo $rating ?>"><?php echo $x; ?></a></li>
                          <?php } else { ?>
                            <li class="page-item"><a class="page-link" href="?page=Buku-Digital-Detail&order=<?php echo $setorder ?>&halaman=<?php echo $x ?> <?php echo $kategori ?> <?php echo $rating ?>"><?php echo $x; ?></a></li>
                        <?php  }
                        }
                        ?>
                        <li class="page-item">
                          <a class="page-link" <?php if ($halaman < $total_halaman) {
                                                  echo "href='?page=Buku-Digital-Detail&order=$setorder&halaman=$next $kategori $rating'";
                                                } ?>> > </a>
                        </li>
                      </ul>
                    </nav>
