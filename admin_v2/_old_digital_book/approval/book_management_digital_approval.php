    ...
    <div class="content-header row">
      <div class="content-header-left col-md-9 col-12 mb-2">
        <div class="row breadcrumbs-top">
          <div class="col-12">
            <h2 class="content-header-title float-start mb-0">Digital Book Approval </h2>
            <div class="breadcrumb-wrapper">
              <ol class="breadcrumb">
                <li class="breadcrumb-item active"><a>Digital Book</a>
                </li>
                <li class="breadcrumb-item active"><a>Digital Book Approval </a>
                </li>
              </ol>
            </div>
          </div>
                  ...
                  ?>
                    ...
                    <tr>
                      ...
                      <?php if ($position == 'Super Admin') { ?>
                        <td><a href="?page=Book-Management-Digital-Approval-Detail&status=Reviewed&id=<?php echo $Code; ?>&v=<?php echo $Version; ?>" target='_self' alt='Approved' class="btn btn-primary btn-sm"><i class='fa fa-check fa-fw'></i> Review</a>
                        </td>
                      <?php } else { ?>
                        <td></td>
                      <?php } ?>
