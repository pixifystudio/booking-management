...
$_SESSION['SES_PAGE'] = "?page=Buku-Bookmark";
...
if ($kategori != '') {
  $kategori = "and category_level_2 ='" . $kategori . "'";
} else {
  $kategori = '';
}
...
$mySql = "SELECT * FROM view_document_favourite where user_id='" . $_SESSION['SES_USERID'] . "' $order";
      ...
      <div class="content-header row">
        <div class="content-header-left col-md-9 col-12 mb-2">
          <div class="row breadcrumbs-top">
            <div class="col-12">
              <h2 class="content-header-title float-start mb-0">Bookmark</h2>
          ...
          <div class="content-detached content-right">
            <div class="content-body">
                      ...
                      <!-- <div class="view-options d-flex">
                        <div class="btn-group dropdown-sort">
                          <button type="button" class="btn btn-outline-primary dropdown-toggle me-1" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <span class="active-sorting">Urutkan</span>
                          </button>
                          <div class="dropdown-menu">
                            <a class="dropdown-item" href="?page=Buku-Detail&order=new">Terbaru</a>
                            <a class="dropdown-item" href="?page=Buku-Detail&order=old">Terlama</a>
                            <a class="dropdown-item" href="?page=Buku-Detail&order=rating">Rating Tertinggi</a>
                          </div>
                        </div>
              ...
              <section id="ecommerce-products" class="grid-view">
                ...
                $mySql = "SELECT * FROM view_document_favourite where user_id='" . $_SESSION['SES_USERID'] . "' $order  limit $halaman_awal, $batas";
                $myQry = mysqli_query($koneksidb, $mySql) or die("BIBLIOTECA ERROR  : " . mysqli_error($koneksidb));
                $nomor = $halaman_awal + 1;

                $User = $_SESSION['SES_USERID'];
                $mySql2   = "SELECT * FROM view_document_favourite where user_id='" . $_SESSION['SES_USERID'] . "' order by document_date desc";
                  ...
                  <div class="card ecommerce-card">
                    ...
                    <div class="card-body">
                      ...
                      <h5 class="item-name">
                        ...
                        <span class="card-text item-company"> <?php echo $category ?> | By <?php echo $publisher ?></span>
                        </h6>
                    ...
                    <div class="item-options text-center">
                      ...
                      ?>
                        ...
                        ?>
                          ...
                          <span class="add-to-cart"><?php echo _BOOKDETAIL ?></span>
                          </a>
                    </div>
                  </div>
                <?php
                      ...
                      <ul class="pagination justify-content-center mt-2">
                        ...
                        <li class="page-item">
                          <a class="page-link" <?php if ($halaman > 1) {
                                                  ...
                                                  echo "href='?page=Buku-Detail&order=$setorder&halaman=$previous $kategori'";
                                                } ?>>
                            < </a>
                        </li>
                        <?php
                        for ($x = 1; $x <= $total_halaman; $x++) {
                          if ($halaman == $x) { ?>
                            <li class="page-item active"><a class="page-link" href="?page=Buku-Detail&order=<?php echo $setorder ?>&halaman=<?php echo $x ?> <?php echo $kategori ?>"><?php echo $x; ?></a></li>
                          <?php } else { ?>
                            <li class="page-item"><a class="page-link" href="?page=Buku-Detail&order=<?php echo $setorder ?>&halaman=<?php echo $x ?> <?php echo $kategori ?>"><?php echo $x; ?></a></li>
                        <?php  }
                        }
                        ?>
                        <li class="page-item">
                          <a class="page-link" <?php if ($halaman < $total_halaman) {
                                                  echo "href='?page=Buku-Detail&order=$setorder&halaman=$next $kategori'";
                                                } ?>> > </a>
                        </li>
                      </ul>
                    </nav>
