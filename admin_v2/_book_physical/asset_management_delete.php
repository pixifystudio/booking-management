...
if (isset($_GET['id'])) {
  ...
  if ($dataStatus  == "Reviewed") {
    echo "<meta http-equiv='refresh' content='0; url=?page=Asset-Management-Digital-Review'>";
  }
  ...
  if ($myQry) {
    // Refresh halaman
    echo "<meta http-equiv='refresh' content='0; url=?page=Asset-Management-Physical&msg=Delete'>";
  }
} else {
