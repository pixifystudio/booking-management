    ...
    <div class="content-header row">
      <div class="content-header-left col-md-9 col-12 mb-2">
        <div class="row breadcrumbs-top">
          <div class="col-12">
            <h2 class="content-header-title float-start mb-0">Education Asset Managements </h2>
            <div class="breadcrumb-wrapper">
              <ol class="breadcrumb">
                <li class="breadcrumb-item"><a>List Education Asset</a>
                </li>
              </ol>
            </div>
          </div>
          ...
          <div class="card">
            <div class="card-header border-bottom">
              <div class="content-header-left col-md-11">
                <h4 class="card-title">List Education</h4>
              </div>
              <div class="content-header-rigth col-md-1">
                <a href='?page=Asset-Management-Physical-Add' type="submit" class="btn btn-secondary" name=""><i data-feather='plus'></i> Add</a>
              </div>
            ...
            <div class="card-datatable">
              <table id="datatable-responsive" class="table datatables-basic table-striped" width="100%">
                ...
                <tbody>
                  ...
                  $mySql   = "SELECT v.* FROM view_document v where category_level_1='PHYSICAL' order  by v.updated_date desc ";
                  ...
                  ?>
                    ...
                    <tr>
                      ...
                      <td><img src=<?php echo "../uploads/cover/" . $Cover; ?> alt="..." class="img-circle" width="30px" height="30px"></td>
                      <td><a href="?page=Asset-Management-Physical-View&id=<?php echo $Code; ?>&v=<?php echo $Version; ?>" alt="View Data"><u><?php echo $myData['document_id']; ?></u></a></td>
                      <td><a href="?page=Asset-Management-Physical-Version&id=<?php echo $Code;  ?>" alt="View Data"><u><?php echo $myData['document_version']; ?></u></a></td>

                      <td><?php echo $myData['document_date']; ?></td>
                      <td><?php echo $myData['document_title_id']; ?></td>
                      <td><a href="?page=Asset-Management-Physical-Status&id=<?php echo $Code;  ?>" alt="View Data"><u><?php echo $myData['document_status']; ?></u></a></td>
                      <td><?php echo $Category; ?></td>
                      <td><?php echo $myData['document_change_history']; ?></td>
                      <td>
                        <a href="?page=Asset-Management-Physical-Print&id=<?php echo $Code; ?>&v=<?php echo $Version; ?>" target="_self" alt="Edit Data"><i data-feather='printer'></i> </a>
                      </td>
                      <td>
                        <?php if ($myData['document_status'] != 'Reviewed' && $myData['document_status'] != 'Request Delete') { ?>
                          <a href="?page=Asset-Management-Physical-Edit&id=<?php echo $Code; ?>&v=<?php echo $Version; ?>" target="_self" alt="Edit Data"><i class="fa fa-edit fa-fw"></i> Edit</a>
                        <?php } ?>
                        <span>|</span>
                        <?php if ($myData['document_status'] != 'Reviewed' && $myData['document_status'] != 'Request Delete') { ?>
                          <a href="?page=Asset-Management-Physical-Delete&id=<?php echo $Code; ?>&v=<?php echo $Version; ?>" target="_self" alt="Delete Data" onclick="return confirm('ARE YOU SURE TO DELETE THIS DATA?')"><i class="fa fa-trash-o fa-fw"></i> Delete</a>
                        <?php } ?>
                      </td>
                    </tr>
                  <?php } ?>
