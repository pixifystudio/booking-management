...
<div class="app-content content ">
  ...
  if (isset($_POST['btnCancel'])) {
    echo "<meta http-equiv='refresh' content='0; url=?page=Asset-Management-Physical'>";
  }
  ...
  if (isset($_POST['btnSubmit'])) {
    ...
    if (count($pesanError) >= 1) {
      ...
      try {
        ...
        commit();
        echo "<meta http-equiv='refresh' content='0; url=?page=Asset-Management-Physical&msg=add'>";
        exit;
      } catch (Exception $e) {
        rollback();
        // echo "<meta http-equiv='refresh' content='0; url=?page=Asset-Management-Physical-Add-Add&id=$Code&info=" . $e->getMessage() . "'>";
        // echo $e->getMessage();
      }
    }
  }
  ...
  $dataDate       = isset($_POST['txtDate']) ? $_POST['txtDate'] : date('Y-m-d', strtotime('+10 year', strtotime($tgl)));
    ...
    <div class="content-header row">
      <div class="content-header-left col-md-9 col-12 mb-2">
        <div class="row breadcrumbs-top">
          <div class="col-12">
            <h2 class="content-header-title float-start mb-0">Add Asset</h2>
            <div class="breadcrumb-wrapper">
              <ol class="breadcrumb">
                <li class="breadcrumb-item active"><a href="index.html">Education Asset Management</a>
                </li>
                <li class="breadcrumb-item"><a href="?page=Asset-Management-Physical">Education Asset</a>
                </li>
                    ...
                    <form action="<?php $_SERVER['PHP_SELF']; ?>" method="post" name="form1" target="_self" enctype="multipart/form-data">
                      <div class="row">
                        ...
                        <div class="col-md-2 col-12">
                          ...
                          <input hidden id="tanggal" autocomplete="off" class="dapick form-control" placeholder="YYYY-MM-DD" name="txtDate" type="text" value="<?php echo $dataDate; ?>" maxlength="20" required="required" autocomplete="off" />
                        </div>
                        ...
                        <div class="col-md-2 col-12">
                          ...
                          <div class="mb-1">
                            ...
                            <input type="file" id="status" class="form-control" required name="txtFileCover" placeholder="Thumbnail" />
                          </div>
                        </div>
