...
if (isset($_POST['btnSubmit'])) {
    ...
    if (count($pesanError) < 1) {
        ...
        if ($myQry) {
            echo "<meta http-equiv='refresh' content='0; url=?page=Asset-Management-Physical-Stock&msg=add'>";
        }
        exit;
    }
                    ...
                    <div class="col-12">
                        ...
                        <div class="breadcrumb-wrapper">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item">Adjust IN</li>
                                </li>
                            </ol>
                        </div>
                    </div>
                        ...
                        <div class="card">
                            <div class="card-header border-bottom">
                                <div class="content-header-left col-12">
                                    <h4 class="card-title">Penyesuaian Stok : Adjust IN</h4>
                                </div>
                            </div>
                            <div class="card-body">
                                <div class="row mt-1">
                                    <div class="col-md-6 col-12 pe-25">
                                        <div class="mb-1">
                                            ...
                                            <select name="txtProduk" class="form-control select2" required>
                                                <?php
                                                $dataQry = mysqli_query($koneksidb, "SELECT
                                                d.document_id,
                                                d.racking_id,
                                                r.racking_number 
                                            FROM
