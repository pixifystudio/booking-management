        ...
        <div class="content-header row">
            <div class="content-header-left col-md-9 col-12 mb-2">
                <div class="row breadcrumbs-top">
                    <div class="col-12">
                        <h3 class="content-header-title float-start mb-0">Laporan</h3>
                        <div class="breadcrumb-wrapper">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item">Laporan Logistik</li>
                                <li class="breadcrumb-item active">Laporan Stok Gudang</li>
                            </ol>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card">
                        <div class="card-header border-bottom">
                            <div class="content-header-left col-md-2 col-12">
                                <h4 class="card-title">Laporan Stok Gudang</h4>
                            </div>
                                ...
                                <form role="form" action="?page=Report-Validasi" method="POST" name="form1" target="_self" id="form1">
                                    <div class="row">
                                        <div class="col-md-3 col-12 px-25">
                                            <div class="mb-1">
                                                <select id="code" class="form-control select2" name="txtCode">
                                                    <option value='' selected>[ Semua Gudang ]</option>
                                                    <?php
                                                    $dataQry = mysqli_query($koneksidb, "SELECT * FROM master_warehouse group by warehouse_id");
                                                    while ($dataRow = mysqli_fetch_array($dataQry)) {
                                                        if ($dataRow['warehouse_id'] == $warehouse_id) $cek = " selected";
                                                        else $cek = "";
                                                        echo "<option value='$dataRow[warehouse_id]|$dataRow[warehouse_name]' $cek>$dataRow[warehouse_id] $dataRow[warehouse_name]</option>";
                                                    }
                                                    ?>
                                                </select>
                                            </div>
                                        ...
                                        <div class="col-md-3 col-12 px-25">
                                            <div class="mb-1">
                                                <select id="subcategory" class="form-control select2" multiple="multiple" tabindex="-1" name="txtSubCategoryArr[]">
                                                    <?php
                                                    $dataQry = mysqli_query($koneksidb, "SELECT product_category FROM master_product
                                        ...
                                        <div class="col-md-2 col-12 px-25">
                                            <div class="mb-1">
                                                <select id="kemasan" class="form-control select2" multiple="multiple" tabindex="-1" name="txtKemasanArr[]">
                                                    <?php
                                                    $dataQry = mysqli_query($koneksidb, "SELECT product_note FROM master_product
                                                    group by product_note");
                                                    while ($dataRow = mysqli_fetch_array($dataQry)) {
                                                        echo "<option value='$dataRow[product_note]' $cek>$dataRow[product_note]</option>";
                                                    }
                                                    ?>
                                                </select>
                                            </div>
                                        ...
                                        <div class="col-md-2 col-12 px-25">
                                            <div class="mb-1">
                                                <input id="tanggal" autocomplete="off" class="dapick form-control" name="txtMonth" type="text" value="<?= $dataMonth; ?>" required />
                                            </div>
                                        </div>
                            ...
                            <table class="table table-striped table-bordered dt-responsive dt-stok-gudang" cellspacing="0" width="100%">
                                ...
                                <tbody>
                                    ...
                                    if ($code != "") {
                                        ...
                                        JOIN master_product p ON s.product_id = p.product_id
                                        WHERE s.stock_date <= '" . $dataMonth . "'
                                        AND s.warehouse_id = '" . $warehouse_id . "'                                        
                                        ";

                                        if ($subcategory != '')
                                            $mySql .= " AND p.product_category IN (" . $subs . ") ";

                                        if ($kemasan != '')
                                            $mySql .= " AND p.product_note IN (" . $kem . ")";

                                        $mySql .= "  GROUP BY s.warehouse_id,s.product_id ORDER BY p.product_category ASC";
                                        // echo $mySql;
...
<script src="js/footer_default.js"></script>
<script>
