        ...
        <div class="content-header row">
            <div class="content-header-left col-md-9 col-12 mb-2">
                <div class="row breadcrumbs-top">
                    <div class="col-12">
                        <h2 class="content-header-title float-start mb-0">Education Asset Inventory</h2>
                        <div class="breadcrumb-wrapper">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a>Education Asset Inventory</a>
                                </li>
                    ...
                    <div class="card">
                                ...
                                <div class="mb-1 breadcrumb-right">
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-end">
                                            <a class="dropdown-item" href="?page=Asset-Management-Physical-Stock-OUT">
                                                <i class="me-1" data-feather="plus-square"></i><span class="align-middle">Adjust OUT</span>
                                            </a>
                                            <a class="dropdown-item" href="?page=Asset-Management-Physical-Stock-IN">
                        ...
                        <div class="card-datatable">
                            <table id="datatable-responsive" class="table datatables-basic table-striped" width="100%">
                                ...
                                <tbody>
                                    <?php
                                    $mySql     = "SELECT s.* FROM view_stock s WHERE LEFT(stock_note,16)='STOCK ADJUSTMENT'   order by s.updated_date desc";
