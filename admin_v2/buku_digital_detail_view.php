...
$_SESSION['SES_PAGE'] = "?page=Buku-Digital-Detail-View&id=" . $getID;
      ...
      <div class="content-header row">
        ...
        <div class="content-header-right text-md-end col-md-3 col-12 d-md-block d-none">
          <div class="mb-1 breadcrumb-right">
            <a class="btn-icon btn btn-primary btn-round btn-sm dropdown-toggle" href="?page=Buku-Digital" aria-haspopup="true" aria-expanded="false"><i data-feather="arrow-left"></i></a>
          </div>
        </div>
      </div>
              ...
              <div class="row my-2  justify-content-center">
                <div class="col-12 col-md-4 d-flex align-items-center  mb-2 mb-md-0">
                  ...
                  <div class="col-12 col-md-12">
                    ...
                    <br>
                    <a href="?page=Document-Detail-PDF&id=<?php echo $myData['document_id']; ?>&v=<?php echo $myData['document_version']; ?>" target="_new" class="btn btn-primary" style='width:100%'><b>Open File</b> </a>
                ...
                <div class="col-12 col-md-7">
                  ...
                  <h2 style='color:brown'> <?php echo _DESC ?></h2>
