  ...
  <div class="app-content content ">
    ...
    if (isset($_POST['btnSubmit'])) {
      ...
      ('$dataCode','BORROWING','$dataUser','OUT','$tgl','1','$dataDocument', '$dataUser | $dataDocument','$dataDateOut', '$dataDateIn', '$ses_nama',now())";
        ...
        commit();
        // exit;
        echo "<meta http-equiv='refresh' content='0; url=?page=Book-Management-Physical-Borrow&msg=add&code=" . $dataCode . "'>";
        // $msg = 'add';
      } catch (Exception $e) {
        rollback();
        // echo "<meta http-equiv='refresh' content='0; url=?page=Book-Management-Physical-Borrow&id=" . $dataCode . "&msg=add'>";
        $pesanError[] =  $e->getMessage();
        // echo "<meta http-equiv='refresh' content='0; url=?page=Book-Management-Physical-Borrow&id=" . $dataCode . "&status=" . $dataStatus . "&info=" . $e->getMessage() . "'>";
        // $msg = 'Failed';
              ...
              <div class="col-12">
                <a href="?page=Main">
                  ...
                  <div class="breadcrumb-wrapper">
                    <ol class="breadcrumb">
                      <li class="breadcrumb-item active"><a>Borrowing Book</a>
                      </li>
                    </ol>
                  </div>
              </div>
