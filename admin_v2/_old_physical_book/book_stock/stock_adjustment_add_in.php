...
if (isset($_POST['btnSubmit'])) {
    ...
    if (count($pesanError) < 1) {
        ...
        if ($myQry) {
            echo "<meta http-equiv='refresh' content='0; url=?page=Book-Management-Physical-Stock&msg=add'>";
        }
        exit;
    }
                    ...
                    <div class="col-12">
                        ...
                        <div class="breadcrumb-wrapper">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">Adjust IN</li>
                                </li>
                            </ol>
                        </div>
                    </div>
                            ...
                            <div class="card-body">
                                <div class="row mt-1">
                                    ...
                                    <div class="col-12 d-flex justify-content-between">
                                        <a href="?page=Book-Management-Physical-Stock" class="btn btn-outline-warning">Batalkan</a>
