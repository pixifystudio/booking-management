...
<div class="app-content content ">
  ...
  if (isset($_POST['btnCancel'])) {
    echo "<meta http-equiv='refresh' content='0; url=?page=Book-Management-Digital'>";
  }
  ...
  if (isset($_POST['btnSubmit'])) {
    ...
    if (count($pesanError) >= 1) {
      ...
      try {
        ...
        commit();
        // echo 'ok';
        echo "<meta http-equiv='refresh' content='0; url=?page=Book-Management-Digital&msg=edit'>";
        exit;
      } catch (Exception $e) {
        rollback();
        // echo "<meta http-equiv='refresh' content='0; url=?page=Book-Management-Digital-Edit&id=$Code&info=" . $e->getMessage() . "'>";
        echo $e->getMessage();
      }
    }
  }
          ...
          <div class="col-12">
            ...
            <div class="breadcrumb-wrapper">
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="?page=Book-Management-Digital">Digital Book</a>
                </li>
