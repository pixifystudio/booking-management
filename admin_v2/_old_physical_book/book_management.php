          ...
          <div class="col-12">
            ...
            <div class="breadcrumb-wrapper">
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active"><a>List Book</a>
                </li>
              </ol>
            </div>
          </div>
          ...
          <div class="card">
            <div class="card-header border-bottom">
              <div class="content-header-left col-md-11">
                <h4 class="card-title">List Physical Book</h4>
              </div>
              <div class="content-header-rigth col-md-1">
                <a href='?page=Book-Management-Physical-Add' type="submit" class="btn btn-danger" name=""><i data-feather='plus'></i> Add</a>
              </div>
            ...
            <div class="card-datatable">
              <table id="datatable-responsive" class="table datatables-basic table-striped" width="100%">
                ...
                <tbody>
                  ...
                  $mySql   = "SELECT v.* FROM view_document v where category_level_1='PHYSICAL'  AND v.document_status like '$st'  and v.category_id 
                  like '$id' and (v.document_version = (select max(w.document_version) 
                    from view_document w where w.document_id=v.document_id) or  v.document_status='Approved') 
                    order  by v.updated_date desc limit 100 ";
                  ...
                  ?>
                    ...
                    <tr>
                      ...
                      <td><a href="?page=Book-Management-Physical-View&id=<?php echo $Code; ?>&v=<?php echo $Version; ?>" alt="View Data"><u><?php echo $myData['document_id']; ?></u></a></td>
                      <td><a href="?page=Book-Management-Physical-Version&id=<?php echo $Code;  ?>" alt="View Data"><u><?php echo $myData['document_version']; ?></u></a></td>

                      <td><?php echo $myData['document_date']; ?></td>
                      <td><?php echo $myData['document_title_id']; ?></td>
                      <td><a href="?page=Book-Management-Physical-Status&id=<?php echo $Code;  ?>" alt="View Data"><u><?php echo $myData['document_status']; ?></u></a></td>
                      <td><?php echo $Category; ?></td>
                      <td><?php echo $myData['document_change_history']; ?></td>
                      <td>
                        <a href="?page=Book-Management-Physical-Print&id=<?php echo $Code; ?>&v=<?php echo $Version; ?>" target="_self" alt="Edit Data"><i data-feather='printer'></i> </a>
                      </td>
                      <td>
                        <?php if ($myData['document_status'] != 'Reviewed' && $myData['document_status'] != 'Request Delete') { ?>
                          <a href="?page=Book-Management-Physical-Edit&id=<?php echo $Code; ?>&v=<?php echo $Version; ?>" target="_self" alt="Edit Data"><i class="fa fa-edit fa-fw"></i> Edit</a>
                        <?php } ?>

                        <?php if ($myData['document_status'] != 'Reviewed' && $myData['document_status'] != 'Request Delete') { ?>
                          <a href="?page=Book-Management-Physical-Delete&id=<?php echo $Code; ?>&v=<?php echo $Version; ?>" target="_self" alt="Delete Data" onclick="return confirm('ARE YOU SURE TO DELETE THIS DATA?')"><i class="fa fa-trash-o fa-fw"></i> Delete</a>
                        <?php } ?>
                      </td>
                    </tr>
                  <?php } ?>
