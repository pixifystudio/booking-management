<?php
$_SESSION['SES_TITLE'] = "Booking on Process";
                ...
                <div class="row breadcrumbs-top">
                    <div class="col-12">
                        ...
                        <div class="breadcrumb-wrapper">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a>Booking on Process</a>
                                </li>
                            </ol>
                        </div>
                    </div>
                        ...
                        <div class="card-datatable">
                            <table class="table datatables-basic table-striped table-bordered dt-responsive " cellspacing="0" width="100%">
                                ...
                                <tbody>
                                    ...
                                    <?php
                                    $mySql   = "SELECT * FROM booking where status ='Dikonfirmasi' and tanggal >= '$tanggal_hari_ini' order by updated_date desc";
