...
<head>
    ...
    <title>Pixify Studio Admin - <?= $_SESSION['SES_TITLE'] ?></title>

    <link rel="apple-touch-icon" href="../app-assets/images/logo/pixify.png">
    <link rel="shortcut icon" type="image/x-icon" href="../app-assets/images/logo/pixify.png">
...
<body class="vertical-layout vertical-menu navbar-floating footer-static" data-open="hover" data-menu="vertical-menu" data-col="">
