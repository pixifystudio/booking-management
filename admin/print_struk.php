...
$pdf = new PDF('P', 'mm', array(50, 140)); // P untuk Portrait, mm untuk milimeter, array(30, 30) untuk ukuran khusus
...
$pdf->Image('../app-assets/images/logo/instagram.png', 27.5,90.3,3);
$pdf->Image('../app-assets/images/logo/whatsapp.png', 4.5, 90.3,3);
$pdf->SetXY($x, $y);
