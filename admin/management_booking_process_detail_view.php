                                    ...
                                    <table class="table">
                                        ...
                                        <tbody>
                                          ...
                                          // ambil data detail struk
                                            $total = 0;
                                            $mySqlDetail   = "SELECT * FROM booking_detail bd left join booking b on bd.booking_id = b.id   where bd.booking_id='$id'  order by bd.booking_detail_id asc";
                        ...
                        <div class="col-xl-3 col-md-4 col-12 invoice-actions mt-md-0 mt-2">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <a class="btn btn-outline-secondary w-100 mb-75" href="?page=Management-Booking-Process-Detail&id=<?= $id ?>"> Edit </a>
